 ...
 * </p>
 */
@TableName("am_imp_modify_template")
public class AmImpModifyTemplate implements Serializable {
     ...
     * 主键
     */
	@TableId(value="imp_modify_template_id", type= IdType.AUTO)
