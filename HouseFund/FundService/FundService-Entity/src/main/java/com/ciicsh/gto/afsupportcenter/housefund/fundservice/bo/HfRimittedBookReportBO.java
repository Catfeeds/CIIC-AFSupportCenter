...
public class HfRimittedBookReportBO implements Serializable {
    ...
    @Excel(name = "企业公积金账号", orderNum = "13", width = 12)
    ...
    @Excel(name = "企业账户类型", orderNum = "13",replace = {"中智大库_1","中智外包_2","独立户_3"}, width = 12)
    ...
    @Excel(name = "补缴人数", orderNum = "12", width = 12)
