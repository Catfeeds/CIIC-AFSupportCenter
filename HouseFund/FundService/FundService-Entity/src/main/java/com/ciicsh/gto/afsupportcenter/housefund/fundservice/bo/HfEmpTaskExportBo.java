...
public class HfEmpTaskExportBo implements Serializable{
    ...
    @Excel(name = "客户编号", orderNum = "5", width = 20)
    private String companyId;
    @Excel(name = "企业客户", orderNum = "4", width = 25)
    private String companyName;
    @Excel(name = "雇员编号", orderNum = "2", width = 20)
    private String employeeId;
    @Excel(name = "雇员", orderNum = "1", width = 20)
    private String employeeName;
    @Excel(name = "雇员证件号", orderNum = "3", width = 25)
...
//    private String isChangeName;
    ...
    @Excel(name = "发起时间", orderNum = "25", width = 20)
    private String submitTimeFormat;
    private Integer taskStatus;
    private String taskId;
    private String createdBy;
    @Excel(name = "发起人", orderNum = "24", width = 20)
