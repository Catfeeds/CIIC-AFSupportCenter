...
//        gc.setXmlName("%sCommandMapper");
        ...
        strategy.setInclude(new String[]{"hm_supply_medical_invoice","hm_supply_medical_dossier","hm_supply_medical_acceptance","hm_acceptance_detailed","hm_acceptance_summary"}); // 需要生成的表
