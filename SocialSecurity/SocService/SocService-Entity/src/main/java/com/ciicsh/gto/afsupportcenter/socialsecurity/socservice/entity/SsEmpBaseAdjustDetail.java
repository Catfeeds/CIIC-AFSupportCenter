...
public class SsEmpBaseAdjustDetail implements Serializable {
     ...
     * 企业缴纳部分差额(未进位)
     */
    @TableField("com_diff_amount_orig")
    private BigDecimal comDiffAmountOrig;
    /**
     * 雇员缴纳部分差额
     */
    ...
    public BigDecimal getComDiffAmountOrig() {
        return comDiffAmountOrig;
    }

    public void setComDiffAmountOrig(BigDecimal comDiffAmountOrig) {
        this.comDiffAmountOrig = comDiffAmountOrig;
    }
	...
	public String toString() {
		return "SsEmpBaseAdjustDetail{" +
            ...
            ", comDiffAmountOrig=" + comDiffAmountOrig +
