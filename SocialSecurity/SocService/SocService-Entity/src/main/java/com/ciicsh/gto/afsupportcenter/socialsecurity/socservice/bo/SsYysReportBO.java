...
public class SsYysReportBO {
    @Excel(name = "企业社保账户", width = 35, orderNum = "1")
    private String comAccountName;
    @Excel(name = "企业社保账号", width = 20, orderNum = "2")
    private String ssAccount;
    @Excel(name = "客户编号", width = 25, orderNum = "3")
    private String companyId;
    @Excel(name = "社保序号", width = 20, orderNum = "4")
    private Long ssSerial;
    @Excel(name = "雇员编号", width = 20, orderNum = "5")
    private String employeeId;
    @Excel(name = "姓名", width = 20, orderNum = "6")
