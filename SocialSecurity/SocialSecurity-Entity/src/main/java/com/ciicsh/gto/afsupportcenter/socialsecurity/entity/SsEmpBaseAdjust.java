...
public class SsEmpBaseAdjust implements Serializable {
     ...
     * 企业个人缴纳金额的差额合计
     */
    @Column(name = "ComEmpSumDiffAmount1")
    private BigDecimal comEmpSumDiffAmount1;
    ...
    /**
     * 获取和上一次调整后的企业缴纳部分金额的差额合计
     *
     * @return ComDiffSumAmount - 和上一次调整后的企业缴纳部分金额的差额合计
     */
    ...
    /**
     * 设置和上一次调整后的企业缴纳部分金额的差额合计
     *
     * @param comDiffSumAmount 和上一次调整后的企业缴纳部分金额的差额合计
     */
    ...
    /**
     * 获取和上一次调整后的雇员缴纳部分金额的差额合计
     *
     * @return EmpDiffSumAmount - 和上一次调整后的雇员缴纳部分金额的差额合计
     */
    ...
    /**
     * 设置和上一次调整后的雇员缴纳部分金额的差额合计
     *
     * @param empDiffSumAmount 和上一次调整后的雇员缴纳部分金额的差额合计
     */
     ...
     * 获取企业个人缴纳金额的差额合计
     *
     * @return ComEmpSumDiffAmount1 - 企业个人缴纳金额的差额合计
     */
    public BigDecimal getComEmpSumDiffAmount1() {
        return comEmpSumDiffAmount1;
    }

    /**
     * 设置企业个人缴纳金额的差额合计
     *
     * @param comEmpSumDiffAmount1 企业个人缴纳金额的差额合计
     */
    public void setComEmpSumDiffAmount1(BigDecimal comEmpSumDiffAmount1) {
        this.comEmpSumDiffAmount1 = comEmpSumDiffAmount1;
    }
