...
import com.ciicsh.gto.afsupportcenter.socialsecurity.business.SsMonthlyEmployeeChangeBusiness;
...
@Log("雇员月度变更主表")
public class SsMonthlyEmployeeChangeController extends BasicController<SsMonthlyEmployeeChangeBusiness> {
