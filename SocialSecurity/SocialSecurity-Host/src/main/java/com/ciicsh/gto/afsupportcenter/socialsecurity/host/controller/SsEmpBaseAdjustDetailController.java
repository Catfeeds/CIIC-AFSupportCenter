...
import com.ciicsh.gto.afsupportcenter.socialsecurity.business.SsEmpBaseAdjustDetailBusiness;
...
@Log("雇员社保基数调整记录明细表")
public class SsEmpBaseAdjustDetailController extends BasicController<SsEmpBaseAdjustDetailBusiness> {
