...
import com.ciicsh.gto.afsupportcenter.socialsecurity.business.SsPaymentDetailBusiness;
...
@Log("本地社保应付金额交易记录明细表")
public class SsPaymentDetailController extends BasicController<SsPaymentDetailBusiness> {
