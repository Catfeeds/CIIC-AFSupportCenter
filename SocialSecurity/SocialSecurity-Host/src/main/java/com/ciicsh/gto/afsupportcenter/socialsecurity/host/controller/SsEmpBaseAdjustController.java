...
public class SsEmpBaseAdjustController extends BasicController<SsEmpBaseAdjustBusiness> {
  ...
  @Log("查询")
  public PageTip<SsEmpBaseAdjust> finds(PageInfo pageInfo) {
    PageRows<SsEmpBaseAdjust> pageRows = business.finds(pageInfo);
    return TipKit.ofPage(pageRows);
  }

  @RequestMapping(value = "/list", method = {RequestMethod.GET, RequestMethod.POST})
  @Log("查询列表")
  public ListTip<SsEmpBaseAdjust> list(SsEmpBaseAdjust entity) {
    List<SsEmpBaseAdjust> list = business.finds(entity);
  ...
  @PostMapping("/save")
  @Log("添加")
  public Tip<String> save(SsEmpBaseAdjust entity) {
  ...
  @PostMapping("/update")
  @Log("更新")
  public Tip<String> update(SsEmpBaseAdjust entity) {
