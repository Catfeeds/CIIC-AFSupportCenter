...
public class SsEmpArchiveBO extends SsEmpArchive {
    ...
    public com.ciicsh.gto.afsupportcenter.socialsecurity.soccommandservice.entity.SsEmpTask getSsEmpTask() {
        return SsEmpTask;
    }

    public void setSsEmpTask(com.ciicsh.gto.afsupportcenter.socialsecurity.soccommandservice.entity.SsEmpTask ssEmpTask) {
        SsEmpTask = ssEmpTask;
    }
}
